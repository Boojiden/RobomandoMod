...
namespace RobomandoMod.Survivors.Robomando.SkillStates
{
    public class Zap : BaseSkillState
    {
        ...
        public static GameObject tracerEffectPrefab = RobomandoAssets.zapTracerEffect;
        ...
        private void Fire()
        {
            if (!hasFired)
            {
                ...
                EffectManager.SimpleMuzzleFlash(RobomandoAssets.zapMuzzleFlashEffect, gameObject, muzzleString, false);
                ...
                if (isAuthority)
                {
                    ...
                    attack.damageType.damageTypeExtended = DamageTypeExtended.Electrical;
                    attack.Fire();
                }
            }
        }
