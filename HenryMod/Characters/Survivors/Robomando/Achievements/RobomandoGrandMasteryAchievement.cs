...
namespace RobomandoMod.Survivors.Robomando.Achievements
{
    ...
    {
        public const string identifier = RobomandoSurvivor.ROBO_PREFIX + "GrandMasteryAchievement";
        public const string unlockableIdentifier = RobomandoSurvivor.ROBO_PREFIX + "GrandMasteryUnlockable";
